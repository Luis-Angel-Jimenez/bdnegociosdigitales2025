...
--Seleccionar las fechas de orden, a�o, dia, cliente que las ordeno y el empleado que las realizo
...
select CustomerID as 'Numero Cliente', CompanyName as 'Nombre Compa�ia', City as 'Ciudad', Country as Pais from Customers where CustomerID = 'BOLID';

Select CustomerID as Identificador, CompanyName as 'Nombre Compa�ia', ContactName as Contacto, City as Ciudad, Country as Pais from Customers where Country = 'Germany';
...
--Los resultados en sus encabezados deben ser en espa�ol.
...
-- Seleccionar pedidos con fletes de peso (Freight) mayor a 100 y enviados a Francia o Espa�a
